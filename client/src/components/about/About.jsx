    ...
    return (
        <Box>
            ...
            <Wrapper>
                ...
                <Text variant="h5">I'm a Student pusuing Btech in Computer science. 
                    I've built website<br />
                    If you are interested, you can view some of my favorite projects here
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/lasyacheela2807" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
